...
const btnVariants = cva(
    "text-center font-helvetica-medium bg-inputBg text-black",
    {
        variants: {
            variant: {
                big: "bg-inputBg text-lg w-full px-20 py-2 active:bg-white border border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:shadow-[3px_3px_0px_0px_rgba(204,11,33,1)]",
